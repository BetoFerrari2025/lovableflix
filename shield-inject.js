  ...
  if (enable) {
    ...
    if (found > 0) {
      ...
      if (firstBlocked) {
        ...
        shield.innerHTML = '<span style="background:rgba(220,38,38,0.9);color:white;padding:4px 14px;border-radius:8px;font-size:12px;font-weight:700;font-family:system-ui,sans-serif;pointer-events:none;white-space:nowrap;">\u{1F512} Use a extensão Lovablex</span>';
